...
config_file = "/content/trait_config_test_sb.json"

config_dict = {}
config_dict['file_type'] = 'envi'
config_dict["output_dir"] = '/content/'
...
images= glob.glob("/content/drive/MyDrive/hytools/data/sb*img")
images.sort()
config_dict["input_files"] = images

config_dict["anc_files"] = {}
anc_files = glob.glob("/content/drive/MyDrive/hytools/data/sb*ans")
anc_files.sort()
...
topo_files = glob.glob("/content/*topo_coeffs*.json")
topo_files.sort()
config_dict["topo"] =  dict(zip(images,topo_files))

brdf_files = glob.glob("/content/*_brdf_coeffs*.json")
brdf_files.sort()
...
##########################################################
models = glob.glob('/content/drive/MyDrive/hytools/data/PLSR_raw_coef*.json')
models.sort()
