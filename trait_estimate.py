...
def apply_trait_models(hy_obj,config_dict):
    ...
    for trait in config_dict['trait_models']:
        ...
        if resample:
            ...
            #hy_obj.resampler['out_fwhm'] = config_dict["resampling"]['out_waves']
            #hy_obj.resampler['out_fwhm'] = config_dict["resampling"]['out_fwhm']
        ...
        if config_dict['file_type'] == 'envi':
            iterator = hy_obj.iterate(by = 'chunk',
                      chunk_size = (2,hy_obj.columns), #hy_obj.columns  32,32
        ...
        #iterator = hy_obj.iterate(by = 'chunk',
        #              chunk_size = (48,48),  #32, 32 100,100
        #              corrections =  hy_obj.corrections,
        #              resample=resample)
